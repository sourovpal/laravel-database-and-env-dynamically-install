...
class CommonEmailTemplate extends Mailable
{
    ...
    public function build()
    {    
        return $this->from('test@gmail.com', $this->template->from)->markdown('email.common_email_template')->subject($this->template->subject)->with('content', $this->template->content);
