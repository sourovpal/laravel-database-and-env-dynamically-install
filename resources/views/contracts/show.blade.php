...
@section('action-button')
    <div class="float-end">
        ...
        @if (\Auth::user()->type == 'owner' && $contract->owner_signature == null || $contract->client == Auth::user()->id && $contract->client_signature == null)    
        ...
        <a href="{{ route('contractclient.index',$contract->id) }}" class="btn btn-sm btn-white rounded-circle btn-icon-only ml-0">
