...
@section('content')
  <div class="row">
    ...
    <div class="mt-3 mb-3 row d-flex align-items-center justify-content-between col-12" id="show_filter">
       ...
       <button class="btn btn-white btn-sm  col-auto btn-filter apply" style="border: 1px solid #E0E6ED;" id="filter"><i class="mdi mdi-check"></i>{{ __('Apply') }}</button>

         <button class=" btn btn-white btn-sm  col-auto " style="border: 1px solid #E0E6ED;">  <a href="{{ route('project_report.export' ,$project->id)}}" class="btn-white">
