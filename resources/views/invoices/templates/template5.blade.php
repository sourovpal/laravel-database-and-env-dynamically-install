                            ...
                            <div data-v-e23d9750="" class="d-inner">
                                <div data-v-e23d9750="" class="row">
                                    ...
                                    <div data-v-e23d9750="" class="col-33">
                                        ...
                                        <p data-v-e23d9750="">@if($invoice_usr->name){{$invoice_usr->name}}@endif</p>
                                ...
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-66"><strong data-v-e23d9750="" class="tu mb5">{{__('Bill To')}}:</strong>
                                        <p data-v-e23d9750="">@if($invoice->client_id == $invoice_usr->id)
                                                {{ $invoice->user->name }}
                                            @else
                                                {{ $invoice->client->name }}
                                            @endif</p>
                                            ...
                                            @if(isset($invoice->items) && count($invoice->items) > 0)
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-e23d9750="" class="d-table-tr">
                                                        ...
                                                        <div data-v-e23d9750="" class="d-table-td w-5"><span data-v-e23d9750="">{{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true) }}</span></div>
                                                        <div data-v-e23d9750="" class="d-table-td w-3 text-right"><span data-v-e23d9750="">{{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-e23d9750="" class="d-table-tr">
                                        ...
                                        <div data-v-e23d9750="" class="d-table-footer">
                                            ...
                                            <div data-v-e23d9750="" class="d-table-summary">
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-e23d9750="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                </div>
                                                @if($invoice->getTax())
                                                    <div data-v-e23d9750="" class="d-table-summary-item">
                                                        <div data-v-e23d9750="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-e23d9750="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="fwb f-b tu d-table-label">{{__('Total')}}:</div>
                                                    <div data-v-e23d9750="" class="fwb f-b d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</div>
                                                </div>
                                                <div data-v-e23d9750="" class="d-table-summary-item">
                                                    <div data-v-e23d9750="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-e23d9750="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
