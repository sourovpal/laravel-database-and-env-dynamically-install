                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                ...
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <h3 data-v-7d9d14b5="" class="sub-title">@if($invoice_usr->name){{$invoice_usr->name}}@endif</h3>
                                    ...
                                    <div data-v-7d9d14b5="" class="col-33">
                                        <div data-v-7d9d14b5="" class="padd"><strong data-v-7d9d14b5="" class="mb5">{{__('To')}}:</strong>
                                            <p data-v-7d9d14b5=""> @if($invoice->client_id == $invoice_usr->id)
                                                    {{ $invoice->user->name }}
                                                @else
                                                    {{ $invoice->client->name }}
                                                @endif</p>
                                            ...
                                            @if(isset($invoice->items) && count($invoice->items) > 0)
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                                        ...
                                                        <div data-v-7d9d14b5="" class="d-table-td w-5" style="padding: 3px;"><span data-v-7d9d14b5="">{{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true) }}</span></div>
                                                        <div data-v-7d9d14b5="" class="d-table-td w-3 text-right" style="padding: 3px;"><span data-v-7d9d14b5="">{{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-7d9d14b5="" class="d-table-tr" style="border-bottom: 1px solid rgb(248, 248, 248);">
                                        ...
                                        <div data-v-7d9d14b5="" class="d-table-footer">
                                            ...
                                            <div data-v-7d9d14b5="" class="d-table-summary">
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                </div>
                                                @if($invoice->getTax())
                                                    <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                        <div data-v-7d9d14b5="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-7d9d14b5="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-7d9d14b5="" class="d-table-summary-item" style="background: {{$color}}; color: {{$font_color}};">
                                                    ...
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</div>
                                                </div>
                                                <div data-v-7d9d14b5="" class="d-table-summary-item">
                                                    <div data-v-7d9d14b5="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-7d9d14b5="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
