                            ...
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                ...
                                <div data-v-4b3dcb8a="" class="row">
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        ...
                                        <strong data-v-4b3dcb8a="" class="sub-title">@if($invoice_usr->name){{$invoice_usr->name}}@endif</strong>
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-2">
                                        <div data-v-4b3dcb8a="" class="col-66">
                                            ...
                                            <strong data-v-4b3dcb8a="" class="sub-title">@if($invoice->client_id == $invoice_usr->id)
                                                    {{ $invoice->user->name }}
                                                @else
                                                    {{ $invoice->client->name }}
                                                @endif</strong>
                                            ...
                                            @if(isset($invoice->items) && count($invoice->items) > 0)
                                                @foreach($invoice->items as $key => $item)
                                                    <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                                        ...
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-5"><span data-v-4b3dcb8a="">{{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true) }}</span></div>
                                                        <div data-v-4b3dcb8a="" class="d-table-td w-3 text-right"><span data-v-4b3dcb8a="">{{ \App\Models\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true) }}</span></div>
                                                    </div>
                                                @endforeach
                                            @else
                                                <div data-v-4b3dcb8a="" class="d-table-tr" style="border-bottom: 1px solid {{$color}};">
                                        ...
                                        <div data-v-4b3dcb8a="" class="d-table-footer">
                                            ...
                                            <div data-v-4b3dcb8a="" class="d-table-summary">
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    ...
                                                    <div data-v-4b3dcb8a="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)}}</div>
                                                </div>
                                                @if($invoice->getTax())
                                                    <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                        <div data-v-4b3dcb8a="" class="tu d-table-label">{{$invoice->tax->name}} ({{$invoice->tax->rate}}%):</div>
                                                        <div data-v-4b3dcb8a="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)}}</div>
                                                    </div>
                                                @endif
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label"><strong data-v-4b3dcb8a="">{{__('Total')}}:</strong></div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value"><strong data-v-4b3dcb8a="">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)}}</strong></div>
                                                </div>
                                                <div data-v-4b3dcb8a="" class="d-table-summary-item">
                                                    <div data-v-4b3dcb8a="" class="tu d-table-label">{{__('Due Amount')}}:</div>
                                                    <div data-v-4b3dcb8a="" class="d-table-value">{{\App\Models\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
